...
/**
 * Major Trauma Activity that display the options a person suspected of
 * Major Trauma should undertake
 * @author Sheng Rong, Darren, Leonard, Bryan, Kendra
 */
public class MajorTraumaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_major_trauma);
        ...
        Button buttonTraumaCall = (Button) findViewById(R.id.buttonTraumaCall);
        buttonTraumaCall.setOnClickListener(new View.OnClickListener() {
            @Override
